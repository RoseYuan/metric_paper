...
external_indices <- function(true, pred, metric="ARI", ...) {
    ...
    if (tolower(metric) == "wh") { # Wallace homogeneity
        return(as.numeric(ClusteringMetrics::getPartitionGlobalMetrics(true, pred, metrics="WH")))
    }
    if (tolower(metric) == "wc") { # Wallace completeness
      return(as.numeric(ClusteringMetrics::getPartitionGlobalMetrics(true, pred, "WC")))
    }
    if (tolower(metric) == "awh") { # Adjusted Wallace homogeneity
        return(as.numeric(ClusteringMetrics::getPartitionGlobalMetrics(true, pred, "AWH")))
    }
    if (tolower(metric) == "awc") { # Adjusted Wallace completeness
      return(as.numeric(ClusteringMetrics::getPartitionGlobalMetrics(true, pred, "AWC")))
    }
    ...
    if (tolower(metric) == "ncr") {
      return(as.numeric(ClusteringMetrics::getPartitionGlobalMetrics(true, pred, "NCR")))
    }
}
```
