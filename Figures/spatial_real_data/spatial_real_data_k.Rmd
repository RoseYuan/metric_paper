...
```{r}
pdf("spatial_metrics_real_data.pdf", width=9, height=7)
p5 <- cowplot::plot_grid(p0, p2, rel_widths=c(1,2), ncol=2, labels=letters[1:2], scale=c(1, 1))
p7 <- cowplot::plot_grid(p6, 
                         p4, 
                         rel_widths=c(1,3.2), ncol=2, labels=c("d",""), scale=c(1, 1))
cowplot::plot_grid(p5, p3, p7, rel_heights=c(1,1,1), ncol=1, labels=c("","c",""), scale=c(1, 1))
dev.off()
```
